...
| MR1 | RELEASE | Cut `miman-v0.1.0-rc1`: release-all → router → DOCR; then bridge B-2 signal | MA1 | Sonnet 5 | no | PENDING — **UNBLOCKED by MA1** (needs `DIGITALOCEAN_ACCESS_TOKEN` before the non-dry publish) | — | — |
